...
int ExampleDepthTest::run() {
    ...
    tris[0].color = Color(1, 0, 0);
    tris[1].color = Color(0, 1, 0);
    tris[2].color = Color(0, 0, 1);
    tris[0].position = { -0.3, -0.3, 0.3 };
    tris[1].position = { 0.7, -0.3, 0.3 };
    tris[2].position = { -0.3, 0.7, 0.3 };
    tris[3].color = Color(1, 1, 0);
    tris[4].color = Color(0, 1, 1);
    tris[5].color = Color(1, 0, 1);
